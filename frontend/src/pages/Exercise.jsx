...
const EXERCISES = [
  ...
  { icon: "☀️", title: "Surya Namaskar (Sun Salutation)", tag: "Yoga-PCOS", duration: "6–12 rounds, daily", benefit: "↓ Insulin resistance", desc: "A complete sequence that activates every muscle group, boosts metabolism, reduces insulin resistance, and helps with weight management — a core challenge in PCOS.", steps: ["Begin in Pranamasana (prayer pose) at the mat's edge", "Flow through: raise arms → forward fold → plank → cobra → downward dog", "Step forward and rise back to standing in one fluid breath", "Each movement linked to an inhale or exhale", "Start with 6 rounds in the morning on an empty stomach"] },
